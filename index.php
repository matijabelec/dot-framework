 ...
 * 
 * @var string representing a root of framework (current directory
 *             because index.php must be in root directory)
 */
define('ROOT', __DIR__ . '/');
...
if(MULTILANG == true) {
    ...
    if(is_null(Cookie::getInstance()->get(DEFAULT_LANG_COOKIE_NAME) ) ) {
        ...
        /* if it is not set, then set new language cookie with 
         * DEFAULT_LANGUAGE
         */
    ...
    /*
     * main registry will always set variable 'language' to current 
     * language (this is like global variable and can be used in any 
     * controller, view, model, etc.)
     */
...
try {
    /*
     * try to find controller for request
     */
